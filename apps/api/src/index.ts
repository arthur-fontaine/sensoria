...
import { hallType } from './schemas/hall'
...
import { getHallsQueryResolver } from './resolvers/queries/get-halls'
...
const resolvers: Resolvers = {
  ...
  Object: {
    ...
    hall: getHallFromObjectQueryResolver,
  },
  Block: {
